...
import (
	...
	"github.com/whosonfirst/go-whosonfirst-internetarchive"
	"io"
	"log"
)
...
func main() {
	...
	opts, err := internetarchive.DefaultWaybackMachineOptions()

	if err != nil {
		log.Fatal(err)
	}

	wb, err := internetarchive.NewWaybackMachine(opts)
